...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
    	...
    	compilationUnit.addFileCommentLine(" * Copyright© 2017 北京金风易通科技有限公司");
...
//        xmlElement.addElement(new TextElement("-->")); //$NON-NLS-1$
    ...
    public void addClassComment(InnerClass innerClass,
        ...
        innerClass.addJavaDocLine(" * @author wanggang");
        innerClass.addJavaDocLine(" * @version 1.0 " + sdf.format(new Date()));
        
        //addJavadocTag(innerClass, false); //@mbggenerated Thu May 25 11:43:48 CST 2017
